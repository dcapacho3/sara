...
class UnifiedNavigationWindow(ctk.CTk):
    ...
    def launch_ros2_files(self):
        ...
        launch_commands = [
            "ros2 launch sara_safety mux.launch.py",
        ]

        if self.nav_mode == "Real":
            launch_commands.append("ros2 launch sara_bringup real_nav.launch.py")
        else:
            launch_commands.append("ros2 launch sara_bringup navagv.launch.py")
